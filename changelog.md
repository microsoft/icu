...
Changes/modifications compared to the upstream `maint/maint-76` branch.
...
- Static link VCRuntime/VCStartup/STL, dynamic link UCRT.
- Include ICU major version number in PDB filenames.
