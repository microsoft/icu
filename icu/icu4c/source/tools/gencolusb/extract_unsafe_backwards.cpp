...
int main(int argc, const char *argv[]) {
  ...
  printf("// © 2016 and later: Unicode, Inc. and others.\n");
  printf("// License & terms of use: http://www.unicode.org/copyright.html\n");
  printf("// collunsafe.h\n");
  printf("//  Copyright (C) 2015-2016, International Business Machines Corporation and others.\n");
